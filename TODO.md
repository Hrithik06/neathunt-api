...
[ ] gmail upgrade route and upgrade callback route has authMiddleware when called from without loggedin user it should show error page or redriect to home
